...
parent_dir = '~/Documents/programming/python/DeepLearning/data/mnist/'
mnist_pkl = parent_dir + 'mnist.pkl'
train_images = parent_dir + 'train-images-idx3-ubyte.gz'
train_labels = parent_dir + 'train-labels-idx1-ubyte.gz'
test_images = parent_dir + 't10k-images-idx3-ubyte.gz'
test_labels = parent_dir + 't10k-labels-idx1-ubyte.gz'
mnist_pkl = os.path.expanduser(mnist_pkl)
train_images = os.path.expanduser(train_images)
train_labels = os.path.expanduser(train_labels)
test_images = os.path.expanduser(test_images)
test_labels = os.path.expanduser(test_labels)
num_train = 60000
num_test = 10000
dim = 784
...
def load_mnist_data():
    if not os.path.exists(mnist_pkl):
        download_mnist_data()
    with open(mnist_pkl, 'rb') as mnist_pickle:
